...
public class Concesionario {
    ...
    private Vehiculo[] cars;
    
    //la variable de clase contador nos indicará cuál es el número de objetos almacenados
     ...
     * @return -2 si la matrícula ya existe
     * @return -1 si el concesionario está lleno
     * @return  0 si se añadió con éxito el nuevo objeto
     */
    ...
    public void listaVehiculos() {
        for (int i = 0; i < contador; i++) {
            ...
            System.out.println("Matrícula:\t"+car.getMatricula());
            System.out.println("Precio:\t\t"+car.getPrecio());
            System.out.println("Kilómetros:\t"+car.getKilometros());
            System.out.println("Descripción:\t"+car.getDescripcion());
        }
    }
    ...
    public boolean borraVehiculo (String matricula) {       
        for (int i = 0; i < contador; i++) {
            ...
            if(car.getMatricula().equals(matricula)) {
                cars[i] = cars[contador-1];
                cars[contador-1] = null;
                contador--;
                return true;
            }
        }
